...
//    }
    ...
    public static String makeCharacterInfoPrompt(String theme) {
        return String.format(
                ...
                지금부터 사용자가 그린 그림과 함께, 동화의 주제를 함께 드릴 것입니다.
                그림의 시각적 요소를 꼼꼼히 분석하고, 주제를 고려하여 상상력 있고 창의적인 '등장인물 가이드(character guide)'를 작성해 주세요.
                출력은 반드시 한국어로 해주세요.
                
                그림은 아이가 직접 그린 것으로, 등장하는 인물(사람, 동물, 판타지 생물 등)의 **외형적인 특징만** 묘사해야 합니다.
                - 외형 묘사 항목 예시:
                  - 성별 및 연령대 (예: 6~7세 정도의 어린 소녀)
                  - 얼굴 (예: 동그란 눈, 작은 코, 주근깨, 밝은 미소)
                  - 머리카락 (예: 짧은 갈색 단발머리, 왼쪽으로 넘긴 앞머리)
                  - 의상과 소품 (예: 파란 줄무늬 티셔츠, 멜빵바지, 빨간 운동화, 곰인형을 안고 있음)
                  - 독특한 요소 (예: 별무늬 망토, 나비채, 날개, 꼬리 등)

                  다음 사항을 반드시 지켜주세요:
                  - 전체 분위기, 배경, 색감 등은 묘사하지 마세요.
                  - 그림에 표현되지 않은 정보는, 주제에 맞춰 상상력 있게 채워 넣어주세요.
                  - 등장인물은 [번호]로 구분하여 작성해 주세요 (예: [1], [2], ...).
                  - 각 등장인물은 다음 항목을 모두 포함한 단락으로 작성해 주세요:
                    - 연령대 / 성별
                    - 얼굴 생김새
                    - 머리 스타일
                    - 옷차림과 소품
                    - 특별한 특징 (판타지 요소, 독특한 포인트 등)

                  주인공 지정:
                    - 등장인물 중 반드시 1명을 **주인공**으로 선택해 주세요.
                    - 이 주인공은 [1]번으로 작성해 주세요.
                    - 주인공은 동화 전체를 이끌 핵심 인물이므로, 외형 묘사에 더 신경 써 주세요.

                  조연 구성:
                     - 주인공 외에도 시각적으로 구분 가능한 인물(사람, 동물, 판타지 생물 등)은 [2], [3], ... 형식으로 순서대로 작성해 주세요.
                     - 조연도 반복 등장할 수 있으므로, 외형 정보를 명확히 남겨 주세요.
